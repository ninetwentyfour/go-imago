...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y fontconfig libjpeg62-turbo xfonts-base xfonts-100dpi libx11-6 libxext6 libxrender1
